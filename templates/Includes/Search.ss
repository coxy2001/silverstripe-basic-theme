<div data-search class="dn--search dn--search--lg" role="search">
  <input class="dn--search-input" type="text" role="search" id="search__input-1" placeholder="Search" aria-labelledby="search-input-label-2">
  ...
  <button class="dn--search-close dn--search-close--hidden" title="Clear search
